    ...
    <div className="flex flex-col md:flex-row flex-wrap bg-primary  px-6 md:px-10 lg:px-20">
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw]">
        ...
        <div className="flex md:items-center flex-col md:flex-row gap-2 ">
          <img className="h-10 w-24 " src={assets.group_profiles} alt="" />
        ...
        <a
          href="#speciality"
          className="flex transition rounded-full gap-2 text-sm hover:scale-105 ease-in-out duration-500 bg-white p-2"
        >
          Book appointment{" "}
